  ...
  const workoutPlan = [
    {
      ...
      steps: [
        { id: 'band-circles', kind: 'movement', name: '弹力带肩部绕环', subtitle: '肩胛活动 · 小幅度、慢速度', equipment: '弹力带', reps: 15, duration: 60, pauseable: true, image: 'band-circles.webp' },
        { id: 'band-pull-apart', kind: 'movement', name: '弹力带拉开', subtitle: '胸背打开 · 保持肋骨下沉', equipment: '弹力带', reps: 15, duration: 60, pauseable: true, image: 'band-pull-apart.webp' },
        { id: 'band-face-pull', kind: 'movement', name: '弹力带面拉', subtitle: '肩后束唤醒 · 手肘向外', equipment: '弹力带', reps: 15, duration: 60, pauseable: true, image: 'band-face-pull.webp' },
        ...
        { id: 'treadmill-walk', kind: 'movement', name: '跑步机快走', subtitle: '能说完整句子即可 · 不追求速度', equipment: '跑步机', duration: 720, pauseable: true, image: 'treadmill-walk.webp' },
      ],
    },
    {
      id: 'strength',
    ...
    },
    {
      ...
      steps: [
        { id: 'foam-calf', kind: 'movement', name: '小腿泡沫轴', subtitle: '脚踝到膝下 · 发现酸点停留呼吸', equipment: '泡沫轴', duration: 60, pauseable: true, image: 'foam-calf.webp' },
        ...
        { id: 'foam-thoracic', kind: 'movement', name: '胸椎伸展', subtitle: '泡沫轴横放 · 配合深呼吸', equipment: '泡沫轴', duration: 60, pauseable: true, image: 'foam-thoracic.webp' },
      ],
    },
  ];
    ...
    return plan.flatMap((stage) => stage.steps.flatMap((step) => {
      ...
      for (let setNumber = 1; setNumber <= step.sets; setNumber += 1) {
        ...
        expanded.push({
          ...
          subtitle: setNumber === step.sets ? '放松呼吸，按暂停后准备下一项' : '喝一口水，保持呼吸平稳',
          equipment: '休息',
          duration: 70,
          pauseable: true,
          image: step.image,
